                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('cron', null, ['id' => 'cron', 'class' => 'form-control', 'placeholder' => 'cron url']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::number('virtual_click', null, ['id' => 'virtual_click', 'class' => 'form-control', 'placeholder' => 'Number Virtual When have Click']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::number('virtual_lead', null, ['id' => 'virtual_lead', 'class' => 'form-control', 'placeholder' => 'Number Virtual When have Lead']) !!}
                            </div>
                        </div>
